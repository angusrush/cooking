...
\section{Spaghetti with feta and oven-roasted tomatoes}
\begin{ingredients}
  $\,$
  \begin{multicols}{2}
    \begin{itemize}
      \item Around 250g tomatoes, cut in half

      \item 1 Tbsp EVOO

      \item 2 cloves garlic, minced

      \item some red chili flakes, to taste

      \item $1/4$ block feta

      \item A handful of spinach
    \end{itemize}
  \end{multicols}
\end{ingredients}
\begin{directions}
  \begin{enumerate}
    \item Preheat oven to $180^{\circ}C$.

    \item In a bowl, toss tomatoes with olive oil, garlic, salt, pepper, and red chili flakes. Transfer to an oven-safe pan. Turn tomatoes so they are skin-side up. Put pan into oven.\footnote{The idea is that the garlic doesn't burn because the tomatoes release a lot of moisture, which pools up in the bottom of the pan. It's a good idea to make sure that the garlic is in the bottom of the pan, where it will be covered by juice, rather than up above.}
      
    \item Put salted water on to boil for pasta. When tomato skins are somewhat shrivelled and brown, add the pasta to the boiling water. At the same time, add the feta into the pan in the oven.

    \item When everything is ready, remove the pan from the oven and put on a burner. Mix the contents of the map together to form a sauce (the block of feta should dissolve into the sauce), and add the pasta, together with cooking water to hold everything together. Wilt in the spinach.
  \end{enumerate}
\end{directions}
...
\begin{ingredients}
  ...
  \begin{multicols}{2}
    \begin{itemize}
      ...
      \item 15g salt. 22g was too much, 15 should be about right, I think.
  ...
  \begin{multicols}{2}
    ...
    \begin{itemize}
      ...
      \item 2 red, orange, or yellow bell peppers, chopped into $1.5$ cm squares

      \item 2 medium large onions, chopped into $1.5$ cm squares
